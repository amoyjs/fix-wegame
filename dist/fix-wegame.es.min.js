...
},syncUniforms:function(a,b){var c=this,d=c.shader,e=c.renderer;/* eslint-disable max-len */syncUniforms(a,d.program.uniformData,b.uniformData,a.uniforms,e)}})}function index(a){a.on("beforeCreate",function(a){var b=a.PIXI;"function"!=typeof eval&&install(b),b.Renderer.create=function(a){return new b.Renderer(a)}})}function deprecatedFixWeGame(a){"function"!=typeof eval&&install(a),a.Renderer.create=function(b){return new a.Renderer(b)}}export default index;export{deprecatedFixWeGame};
//# sourceMappingURL=fix-wegame.es.min.js.map
